---
name: writer
description: "Step 6: AI-assisted writing command. Implements Write Mode, Draft Detection, and a 12-item pre-write checklist to maintain consistency and context."
tools:
  - "*"
kind: local
...
### 4. CRITICAL: Pre-Write Checklist
...
11. **Pacing Type** — Check the chapter's pacing tag in `./stories/[novel-name]/tasks.md` (`[Action]`, `[Reflection]`, `[Climax]`, etc.). Write accordingly.
